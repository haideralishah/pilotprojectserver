module.exports = function (app, mongoose, moment, momentTimezone, Bcrypt, sanitizeHtml, Converter, multer, path, fs) {
    ...
    app.post('/uploadAngularSchool', multer({ dest: "./uploads/" }).array("uploads[]", 12), app.api.User.uploadAngularSchool);
    ...
    app.post('/getAngularSchoolData', app.api.User.getAngularSchoolData);
